"""Engineering layer — pure analytical checks for footing pre-design.
...
C and C' critical sections, geometric overhang and AABB overlap. Each function
...
Resumo em português:
    Camada de engenharia. Verificações analíticas puras para
    pré-dimensionamento de sapatas isoladas: tensão admissível preliminar
    do solo, σ_max e σ_min, restrição de tensão, geometria mínima, punção
    (seções C e C') e sobreposição AABB.
"""
