...
def obter_textos():
    return {
        "pt": {
            ...
            "info_otim": "Iniciando otimização...",
            "sucesso_otim": "Dimensionamento concluído!",
        ...
        "en": {
            ...
            "info_otim": "Starting optimization...",
            "sucesso_otim": "Design completed successfully!",
...
with col1:
    ...
    cob = st.number_input(t["cob"], step=0.5, value=2.0, format="%.1f")
...
with col2:
    ...
    n_gen = st.number_input(t["n_gen"], min_value=2, max_value=200, step=1, value=10)
    n_pop = st.number_input(t["n_pop"], min_value=100, max_value=2000, step=5, value=300)
